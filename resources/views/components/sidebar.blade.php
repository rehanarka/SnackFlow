...
<div id="sidebar" class="transition-all duration-300 ease-in-out fixed top-0 left-0 z-40 w-64 h-screen pt-7 pl-5 pr-4 overflow-hidden  bg-neutral-primary-soft border-r border-gray-300 shadow-xl bg-white" tabindex="-1" aria-labelledby="drawer-navigation-label">
  <div class="border-b border-gray-300 pb-4 flex flex-col">
      ...
      <p class="text-gray-400">Manajemen Penjualan</p>
   </div>
  <div class="py-5 overflow-hidden">
      <ul class="space-y-2 font-medium">
         <li>
            <a href="{{ @if }}" class="flex {{ request()->is('dashboard') ? 'bg-blue-100' : 'bg-' }} items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
               <svg class="w-5 h-5 transition duration-75 {{ request()->is('dashboard') ? 'text-blue-600 ' : 'text-black' }} group-hover:text-fg-brand" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6.025A7.5 7.5 0 1 0 17.975 14H10V6.025Z"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.5 3c-.169 0-.334.014-.5.025V11h7.975c.011-.166.025-.331.025-.5A7.5 7.5 0 0 0 13.5 3Z"/></svg>
               <span class="m-3 {{ request()->is('dashboard') ? 'text-blue-600' : 'text-black' }}">Dashboard</span>
            </a>
         </li>
         <li>
