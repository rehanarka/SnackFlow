    ...
    <div class="">
        ...
        <div class="flex flex-col justify-center items-center h-screen gap-4">
            ...
            <form action="/register" method="post">
                ...
                <p>Already have an account? <a href="/login" class="text-blue-600 mt-2">Login here!</a></p>
                <button class="transform hover:transition-transform duration-150 hover:scale-110 hover:bg-blue-400 active:transition-transform active:scale-90 cursor-pointer rounded-3xl bg-blue-300 w-32 py-2 mt-7">Sign Up</button>
                @if($errors->first())
