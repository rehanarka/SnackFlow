        ...
        <div class="grid gap-0 md:grid-cols-[0.95fr_1.05fr]">
            ...
            <div class="flex flex-col px-6 py-6 sm:px-8">
                <div class="flex items-start justify-between gap-4">
                    ...
                    <button type="button" id="closeProductDetailModal" class="rounded-full bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-600 transition duration-300 hover:bg-slate-200">&times;</button>
                </div>
