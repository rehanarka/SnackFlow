        ...
        <div class="relative min-h-[calc(100vh-97px)] w-full overflow-hidden">
            ...
            <div class="relative z-10 flex justify-between">
                <div class="flex flex-col items-center justify-center ml-20 mt-50">
                    ...
                    <img class="-mt-30" src="/images/logoBersih-opt.png" alt="Logo SnackFlow" width="520" height="346" fetchpriority="high" decoding="async">
                </div>
                <div class="bg-white/55 rounded-lg w-160 h-fit mt-30 border border-white mr-50 p-12 ngambang shadow-white shadow-2xl">
                    ...
                    <div class="flex mt-10 justify-center items-center gap-10">
                        ...
                        <a class="bg-black/70 border text-lg rounded-2xl px-18 py-2 text-white font-semibold border-white hover:-translate-y-1 hover:shadow-white hover:shadow-md transition duration-300 hover:bg-gray-600" href="/registrasi">Sign Up</a>
                    </div>
                </div>
            </div>
        </div>
