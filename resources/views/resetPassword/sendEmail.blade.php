            ...
            <div class="px-4">
                ...
                <div>
                    ...
                    <div class="relative mt-2">
                        <input autocomplete="off" type="email" id="email" name="email" class="block w-full h-10 pl-8 pr-3 mt-1 text-sm text-gray-700 border focus:outline-none rounded shadow-sm focus:border-blue-500" placeholder="email@example.com"/>
